...
In this example a combination of various attributes such as method name split in camel case notation ``draw String'', keywords from both class and method description resulted in the Android API equivalent method \CodeIn{drawText} shown in Figure~\ref{fig:drawTextJavadoc} in the top ten results.
