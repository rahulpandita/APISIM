...
\textbf{TF-IDF Similarity}\cite{manning2008introduction}: Term -frequency inverse-document-frequency (\CodeIn{tf-idf}) is a numerical statistic that is intended to capture the importance of a term to a document in a corpus.
