...
\title{Inferring Likely Mappings Between APIs using Text Mining}
...
% 1st. author
\alignauthor
{\large Rahul Pandita$^\dagger$, Raoul Jetley$^\mp$, Sithu D Surarsan$^\mp$, and Laurie Williams$^\dagger$}\\%\titlenote{Dr.~Trovato insisted his name be first.}\\
\affaddr{$^\dagger$North Carolina State University, Raleigh, NC, USA}\\
\affaddr{$^\mp$ABB Corporate Research, Bangalore, KA, India}\\
\email{{\normalsize rpandit@ncsu.edu, abc@xyz.com, williams@csc.ncsu.edu, sudarsan.sd@in.abb.com}}
}
