 ...
 *
 */
public class Eval2 extends PremEval<APIMtd> 
{
	...
	public Eval2(List<APIType> clazzList, String idxFileLoc) 
	{
		super(idxFileLoc);
		initialize(clazzList);
	}
	
	public Eval2(List<APIType> clazzList, String idxFileLoc, Analyzer analyzer) 
	{
