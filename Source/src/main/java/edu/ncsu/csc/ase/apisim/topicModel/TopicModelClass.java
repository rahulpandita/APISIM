...
public class TopicModelClass extends TopicModelFactory {
	...
	public InstanceList getTargetInstanceList() {
		try 
		{
			return InstanceCreator.createInstanceList(false, Configuration.ANDROID_DUMP_PATH,Configuration.MIDP_DUMP_PATH);
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
	...
	public InstanceList getSearchInstanceList() {
		try 
		{
			return InstanceCreator.createInstanceList22(false, Configuration.MIDP_DUMP_PATH);
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
