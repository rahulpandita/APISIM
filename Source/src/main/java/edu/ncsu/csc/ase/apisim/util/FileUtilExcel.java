...
public class FileUtilExcel {
	...
	public static final String fileName = "ResultsMIDPred.xls";
	...
	public void writeDataToExcel1(String c1, String c2) throws Exception
	{
		String[][] excelData = new String[1][2];
		excelData[0][0] = c1;
		excelData[0][1] = c2;
	...
	public void writeDataToExcelBold(String ... cell) throws Exception
	{
		HSSFRow myRow = null;
		HSSFCell myCell = null;
	...
	public void writeDataToExcel11(String ... cell) throws Exception
	{
		HSSFRow myRow = null;
		HSSFCell myCell = null;
