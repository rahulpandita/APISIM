...
Our results indicate that \tool\ on average found relevant mappings for 56\% and 57\% more methods compared to the Rosetta and the StaMiner approaches respectively. 
Our results also show promise in leveraging user feedback to prune irrelevant suggestions in the \tool\ output.
